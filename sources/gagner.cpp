...
void gagner(sf::RenderWindow &window, int** brique, int nbLignes, int nbColonnes,int &niveau){
    int score = 0;
...
void menugagner (sf::RenderWindow &window,sf::RenderWindow &gagner,int** brique){ // On crée une fonction "menuGagner" pour lancer une fenètre avec des boutons niveau suivant & quitter lorsque l'on a gagné
